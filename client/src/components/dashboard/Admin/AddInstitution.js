                ...
                <div className=' rowcol-md-12 col-lg-12 col-sm-12 col-xs-12'>
                    ...
                    <div class="row form-group ">
                        <div class="control-group col-md-8 col-lg-8 col-sm-8 col-xs-8">
                            ...
                            <div class="controls">
                                <label style={{ cursor: "pointer" }}><input className="radio" type="radio" id="institution" name="eventchange" value="institution" onclick="ShowHideDiv()" />&nbsp; Institution</label>&nbsp;&nbsp;
                                <label style={{ cursor: "pointer" }}><input className="radio" type="radio" id="individuals" name="eventchange" value="individuals" onclick="ShowHideDiv()" />&nbsp; Individual</label>
                            </div>
                        </div>
                    </div>
                    <div className="row form-group  col-md-12 col-lg-12 col-sm-12 col-xs-12" id="eventDiv" >
                        <div className="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            <label className="control-label" id="ent_order_desg_lbl">Institution Name</label>
                            <label className="control-label" id="ent_name_label" > </label>
                            <div className="controls">
                                <input name="ent_name" id="ent_name" type="text" className="form-control required" value="" />
                            </div>
                        </div>
                        <div className="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12" id="orderDiv" >
                            <label className="control-label" id="ent_order_desg_lbl">Order</label>
                            <div className="controls">
                                <input name="ent_order_desg" id="ent_order_desg" type="text" className="form-control" value="" />
                            </div>
                        </div>
                        ...
                        <div className="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            ...
                            <div className="controls">
                                <input name="ent_email" id="ent_email" type="text" className="form-control validEmail" value="" />
                        ...
                        <div className="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12">
                            ...
                            <div className="controls">
                                <input name="ent_addl_email" id="ent_addl_email" type="text" className="form-control validEmail" value="" />
                                <span className="form-input-info positioning" ></span>
                            </div>
                        </div>
                        ...
                        <div className="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12" id="orderDiv" >
                            <label className="control-label" id="ent_order_desg_lbl">Institution URL</label>
                            <div className="controls">
                                <input name="ent_order_desg" id="ent_order_desg" type="text" className="form-control" value="" />
                            </div>
                        </div>
                        ...
                        <div className="control-group col-md-6 col-lg-6 col-sm-6 col-xs-12" id="orderDiv" >
                            <label className="control-label" id="ent_order_desg_lbl">Contact No.</label>
                            <div className="controls">
                                <input name="ent_order_desg" id="ent_order_desg" type="text" className="form-control" value="" />
                            </div>
                        </div>
            ...
            <div class="control-group col-md-12 col-lg-12 col-sm-12 col-xs-12">
				...
				<div className="control-group col-md-12 col-lg-12 col-sm-12 col-xs-12" >
                    ...
                    <div class="row form-group col-md-12 col-lg-12 col-sm-12 col-xs-12" id="postageDiv" >
                        ...
                        <div class="control-group col-md-8 col-lg-8 col-sm-8 col-xs-12">
                            <label class="control-label" >Address line2 <span style={{ color: "#800000" }}>*</span></label>
                            <div class="controls">
                                <input name="ent_addl2" id="ent_addl2" type="text" class="form-control required" value="" maxlength="38" />
                            </div>
                        </div>
                        <div class="control-group col-md-4 col-lg-4 col-sm-4 col-xs-12">
                            <label class="control-label" >State </label>
                            <div class="controls">
                                <input name="ent_state" id="ent_state" type="text" class="form-control" value="" />
                            </div>
                        </div>
                        <div class="control-group col-md-8 col-lg-8 col-sm-8 col-xs-12">
                            <label class="control-label" >Address line3 </label>
                            <div class="controls">
                                <input name="ent_addl3" id="ent_addl3" type="text" class="form-control" value="" maxlength="38" />
                            </div>
                        </div>
                        <div class="control-group col-md-4 col-lg-4 col-sm-4 col-xs-12 " >
                            <label class="control-label" >Pincode <span style={{ color: "#800000;" }}>*</span></label>
                            <div class="controls ">
                                <input name="ent_pincode" id="ent_pincode" maxlength="6" type="text" class="form-control required" value="" />
                            </div>
                        </div>
                    </div>
